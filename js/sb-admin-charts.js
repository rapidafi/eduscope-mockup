...
$.getJSON("https://sa.rapida.fi/eduscope.php/koulutus_perus_kk_ala_vuosi/organisaatio_koodi="+qOrganization+"/vuosi="+qYear+"?version="+EDUSCOPE_VERSION, function( data ) {
  var eduscope = {};
  eduscope.labels = [];
  eduscope.degrees = [];
  eduscope.students = [];
